...
class TipoPagoModel(SQLModel, table=True):
    __tablename__ = "TipoPago"
    
    idTipoPago: int | None = Field(default=None, primary_key=True)
    ...
    # Relación 1 a N: un tipo de pago tiene muchos expedientes
    expedientes: List["ExpedienteModel"] = Relationship(back_populates="tipoPago")